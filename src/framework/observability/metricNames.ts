export const METRIC_NAMES = Object.freeze({
  ...
  sloMetricValue: 'auroraflow_slo_metric_value',
  sloAlertBreachesTotal: 'auroraflow_slo_alert_breaches_total',
  selfHealingArtifactsTotal: 'auroraflow_self_healing_artifacts_total',
  selfHealingDomSnapshotDurationMs: 'auroraflow_self_healing_dom_snapshot_duration_ms',
  selfHealingFailurePathDurationMs: 'auroraflow_self_healing_failure_path_duration_ms',
  ...
  selfHealingRegistryWritesTotal: 'auroraflow_self_healing_registry_writes_total',
