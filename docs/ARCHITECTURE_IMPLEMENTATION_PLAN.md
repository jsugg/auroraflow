...
| `AUR-IMPL-023` | Implement lifecycle helper and Playwright fixture | 2 | P1 | devex | Complete | `012`, `024` | runtime/devex | M | `013`, `021` | none | Fixture example cleans telemetry/Redis without manual shutdown. |
